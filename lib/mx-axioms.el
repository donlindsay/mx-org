;; https://github.com/RDFLib/OWL-RL/blob/master/RDFClosure/AxiomaticTriples.py
;; has taken this to the next level of refinement in python
;; which is closer to elisp/org than what I started with.
;; I'm going to take a page out of this well
;; documented library and port this over instead of
;; doing alot of unnecessary duplication.
;;
